...
if($sent) {
  ...
  echo $message_view_modal.
        "<div id='messagePreview'><div class='row-fluid'><div class='span12'></div></div><div class='row-fluid'><div class='span3'><strong>To</strong></div><div class='span5'><strong>Subject</strong></div><div class='span2'><strong>Date/Time</strong></div><div class='span2'><strong>Action</strong></div></div></div>".
           $table_body_rows.
        "</div>";

} else {

  echo "<div id='messagePreview'><div class='row-fluid'><div class='span12'></div></div><div class='row-fluid'><strong>Sorry, no messages in sent items.</strong></div></div>";
}
?>