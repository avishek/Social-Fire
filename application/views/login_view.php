...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Sign in &middot; Social Fire</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" name="login_input" action="<?php echo site_url("login"); ?>" method="post">
        ...
        <a class="btn btn-large btn-warning pull-right" href="<?php echo site_url("login/up"); ?>">Sign up</a>
      </form>
